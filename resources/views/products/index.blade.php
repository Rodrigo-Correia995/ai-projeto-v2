            ...
            <table class="table-auto w-full border-collapse">
                <thead>
                    <tr class="border-b-2 border-gray-400 dark:border-gray-500 bg-gray-100 dark:bg-gray-800">
                        ...
                        <th class="px-4 py-3 text-left min-w-[140px]">Options</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($allProducts as $product)
                        <tr class="border-b border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-4 py-3 flex space-x-4">
                                ...
                                <form method="POST" action="{{ route('products.destroy', $product) }}" onsubmit="return confirm('Are you sure you want to delete this product?');" aria-label="Delete product">
                                    @csrf
                                    @method('DELETE')
